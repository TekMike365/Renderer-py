...
vertices = [
    ...
    [re.Vec3(0.5, -0.5, -0.5), re.Vec3(0.0, 1.0, 1.0)],
    [re.Vec3(0.5, -0.5, 0.5), re.Vec3(0.0, 1.0, 0.0)],
    [re.Vec3(-0.5, -0.5, 0.5), re.Vec3(1.0, 1.0, 0.0)],
    [re.Vec3(-0.5, 0.5, -0.5), re.Vec3(1.0, 0.0, 1.0)],
    [re.Vec3(0.5, 0.5, -0.5), re.Vec3(0.0, 0.0, 1.0)],
    [re.Vec3(0.5, 0.5, 0.5), re.Vec3(0.0, 0.0, 0.0)],
